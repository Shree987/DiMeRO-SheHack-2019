...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { date: @prescription.date, doctor_id: @prescription.doctor_id, patient_id: @prescription.patient_id, pres_obs: @prescription.pres_obs, pres_sym: @prescription.pres_sym, presname: @prescription.presname } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { date: @prescription.date, doctor_id: @prescription.doctor_id, patient_id: @prescription.patient_id, pres_obs: @prescription.pres_obs, pres_sym: @prescription.pres_sym, presname: @prescription.presname } }
